    ...
    <div className="px-4 py-6 space-y-8">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="space-x-2">
          ...
          <span className="px-3 py-1 text-sm font-semibold tracking-wide uppercase bg-green-500 rounded-full text-red-50">
            {status} order
          </span>
        </div>
      </div>
      ...
      <ul className="border-t border-b divide-y divide-stone-20">
        {cart.map((item) => (
          <OrderItem
            item={item}
            key={item.pizzaId}
